  ...
  return list.length ? _react.default.createElement(Wrapper, {
    ...
    return _react.default.createElement(_button.TabButton, {
      ...
      onClick: function onClick(e) {
        return e.preventDefault() || actions.onSelect(id);
      },
      role: "tab"
  ...
  _createClass(TabsState, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          scroll = _this$props$scroll === void 0 ? true : _this$props$scroll;
...
TabsState.propTypes = {
  children: _propTypes.default.arrayOf(_propTypes.default.oneOfType([_propTypes.default.node, _propTypes.default.func])),
